...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer(@"Server=localhost;Database=northwind;User Id=sa;Password=pass1234");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            modelBuilder.Entity<Bets>(entity =>
            {
                ...
                entity.Property(e => e.StakeAmount).HasColumnType("decimal(26, 6)");

                entity.HasOne(d => d.Member)
                    .WithMany(p => p.Bets)
                    .HasForeignKey(d => d.MemberId)
                    .OnDelete(DeleteBehavior.ClientSetNull)
                    .HasConstraintName("FK_Bets_Members");
            });
